...
\tab{tab:baseline_cmu}{Baseline CMUSphinx results compared with \ac{sigm} 2021 results. All models have been trained with 10000 steps and the default settings. The framework provides a WER implementation which has been used to evaluate the models.}{
...
\hline
\textbf{ISO396-3} & \textbf{Baseline WER} & \textbf{other model WER} & \textbf{Notes} \\
\hline
\hline
eng (us) & 54.40 & 37.43 & broad \\
fra & 7.20 & 5.11 & broad \\
ell & 9.80 & 18.67 & broad \\
kat & 0.30 & 0.00 & broad \\
hin & 5.60 & 5.11 & broad \\
jpn & 6.60 & 4.89 & narrow \\
kor & 28.70 & 16.20 & narrow \\
vie & 7.50 & 0.89 & narrow \\
\hline
\end{tabularx}}{Baseline Results}