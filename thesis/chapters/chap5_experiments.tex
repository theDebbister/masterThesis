...
Apart form the characters that I cleaned out in table \ref{tab:preprocessing}, there were a few more characters that needed o be cleaned. The cleanings here were a classic example for the Unicode normalization issues that I presented in section \ref{sec:unicode_ipa}. \review{finish this}
...
\hline
\hline
eng (us) & 53.00 & 87.60 & \textbf{37.43} & broad \\
fra & 7.20 & 47.20 & \textbf{5.11} & broad \\
ell & \textbf{9.80} & 83.20 & 18.67 & broad \\
kat & 0.30 & 65.20 & \textbf{0.00} & broad \\
hin & 5.60 & 87.10 & \textbf{5.11} & broad \\
jpn & 6.60 & - & \textbf{4.89} & narrow \\
kor & 26.70 & 100.00 & \textbf{16.20} & narrow \\
vie & 3.00 & 100.00 & \textbf{0.89} & narrow \\
\hline
\end{tabularx}
