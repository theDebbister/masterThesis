...
\begin{covsubexamples}[preamble={This example shows a precomposed character and the different characters it is made of. Note the different code points. If the character was not precomposed, it would simply have two code points similar to subexample (d).}]
