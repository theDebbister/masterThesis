...
\begin{center}
\begin{vowel}
	\putvowel{\small{front-close}}{-1\vowelhunit}{0\vowelvunit}
	\putvowel{\small{back-close}}{5\vowelhunit}{0\vowelvunit}
	\putvowel{\small{front-open}}{1\vowelhunit}{3\vowelvunit}
	\putvowel{\small{back-open}}{5\vowelhunit}{3\vowelvunit}
	\putcvowel[l]{i}{1}
	\putcvowel[r]{y}{1}
	\putcvowel[l]{e}{2}
	\putcvowel[r]{\o}{2}
