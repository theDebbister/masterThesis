...
übungsbuch & \textipa{y: b U N s b u: x}    & \textipa{y:} BA \textipa{b } AH \textuipa{U } AN \textipa{N } AG \texipa{s } AJ \textipa{b } AH \textipa{u: } BA \textipa{x } AJ  \\
