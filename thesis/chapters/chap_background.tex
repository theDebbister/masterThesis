...
\subsection{SIGMORPHON shared tasks}
\label{sig20}
\label{sig21}
...
\section{CMUSphinx}
This model has been used on the \ac{sigm} task. It was not used on many language but promised a good performance which is why I decided to use this model for this present thesis. \review{add explanation of model}
