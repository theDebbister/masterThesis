...
\review{The WER describe here is what we use as PER in the paper. We calculate the WER by simply counting words that have an error and words that do not have an error}
