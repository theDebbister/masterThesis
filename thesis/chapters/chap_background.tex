...
}& \multicolumn[c]{2}{0.14\textwidth}{medium (10,000 words)}
& & hye (arm\_e) & 6.4 \\
& & jpn (jpn\_hira) & 5.0 \\
& & hun & 1.0 \\
& & vie (vie\_han) & 2.0 \\
...
& & cym (wel\_sw) & 10 \\
\hline
\multirow[t]{6}{0.14\textwidth}{SIG21: \citet{lo-nicolai-2021-linguistic}}& \multirow[t]{6}{0.5\textwidth}{Only their second model, UBC-2, outperforms the baseline. They analysed the errors of the baseline and extend it by adding penalties for wrong vowels and wrong diacritics. Errors on vowels actually decreased. The macro-average outperformed all other systems (low-resource task). Only low-resource participation.
}& ady & 22 \\
& & khm & 28 \\
& & lav & 49 \\
& & rum & 10 \\
