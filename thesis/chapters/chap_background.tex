...
\begin{itemize}
\item ǃ: this glyph represents an exclamation mark with unicode code point U+0021.
\item !: the glyph represents an post-alveolar click with unicode code point U+01C3.
\end{itemize}

It is striking that these two look exactly the same. 
